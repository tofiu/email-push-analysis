...
select userid, 
'short' as audience,
DATE(2021, 03, 14) as email_date
from temp_tliu.uefa_short_open),

long_users as (
select userid, 
'hlong' as audience, 
DATE(2021, 03, 14) as email_date
from temp_tliu.uefa_long_open),
...
cancelled_users as (
  ...
  where
    ...
    and ui.expiration_dt between u.email_date and '2021-07-13'
  group by
   1
)
,
...
or ui.expiration_dt > '2021-07-13'
group by 1
)
